...
مدل‌های زبانی، و در صورت تناسب مدل‌های باز، به جست‌وجو، استخراج، ترجمه، مقایسه و توضیح کمک می‌کنند. جای دیگری هم هست برای مدلی کوچک که فقط به پرسش ثابت جواب بدهد و یک احتمال برگرداند: دسته‌بندی، مسیردهی، امتیازدهی بر معیارهای اعلام‌شده، یا علامت‌زدن برای بازبینی انسانی. Jev از TypeSafe سرویسی میزبانی‌شده و دارای مجوز با همین توانایی است. Laya مدلی با وزن‌های باز از همین نوع است. مهم توانایی است و این جا باید قابل تعویض بماند. ادعاهای سازنده دربارهٔ سرعت، هزینه و کالیبراسیون تا وقتی روی زبان و داده و پرسش‌های واقعی کاویان آزموده نشده‌اند، ادعای فروشنده‌اند. احتمال خروجیِ هر کدام، خروجیِ مدل روی یک کار تعریف‌شده است. نه حکم به درستی یک گزارش است و نه بهترین تصمیم برای یک مردم.
...
مدل تصمیم در این نمونه فقط می‌تواند به مسیردهی برگه‌ها کمک کند، یا روی یک سنجهٔ ازپیش‌تعریف‌شده علامت بزند که بودجه و زمان‌بندی ناسازگارند. Jev یا Laya می‌توانند این گام را پر کنند. هیچ‌کدام حق امتیازدادن به پرسش ارزش را ندارند. ترجمان، نمای عمومی را به زبان روشن می‌نویسد. نگهبان نسخه‌ای را که مردم دیده‌اند ذخیره می‌کند، و اگر نهاد جواب بدهد نسخهٔ بعدی را هم. خواننده می‌تواند تشخیص بدهد چه چیز منبع دارد، چه چیز برآورد است، چه چیز تعارض ارزش است، و اصلاح را کجا اضافه کند.
...
| مدل تصمیم نامزدی برای گام‌های ساختاریافتهٔ محدود است، کنار مدل‌های زبانی. Jev میزبانی‌شده است و Laya وزن باز دارد | مغز سیستم نیست. وزن باز ممیزی نیست، و هیچ‌کدام روی متن مدنی فارسی کاویان آزموده نشده‌اند |
...
۳. **نوشتن دروازهٔ نوع پرسش به‌صورت قاعده** که هم عامل و هم متصدی انسانی دنبال کنند، از جمله اینکه مدل تصمیم کدام نوع پرسش را حق امتیازدادن ندارد.  
